...
def login(request):
    ...
    if serializer.is_valid():
        identification = serializer.validated_data['identification']  # Aquí accedes a los datos validados
        password = serializer.validated_data['password']  # Aquí accedes a los datos validados
        try:
            user = User.objects.get(identification=identification)  # Asegúrate de usar el campo correcto para buscar

            # Convertir la contraseña hash de la base de datos a bytes si es un string
